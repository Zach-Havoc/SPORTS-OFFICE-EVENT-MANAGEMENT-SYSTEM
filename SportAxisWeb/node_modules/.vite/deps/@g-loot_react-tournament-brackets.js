...
var store = (0, import_react2.createContext)(initialState);
var { Provider } = store;
var MatchContextProvider = ({ children }) => {
...
var getCalculatedStyles = (style = defaultStyle) => {
...
var generatePreviousRound = (matchesColumn, listOfMatches) => matchesColumn.reduce((result, match) => {
  return [
    ...result,
...
var match_wrapper_default = Match;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/components/round-header.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
var Text = styled_components_browser_esm_default.text`
  font-family: ${({ theme }) => theme.fontFamily};
  color: ${({ theme }) => theme.textColor.highlighted};
`;
var Rect = styled_components_browser_esm_default.rect.attrs(({ theme }) => ({
...
var calculateVerticalStartingPoint = (columnIndex, height) => 2 ** columnIndex * (height / 2) - height / 2;
var columnIncrement = (columnIndex, height) => 2 ** columnIndex * height;
var calculateHeightIncrease = (columnIndex, rowIndex, height) => columnIncrement(columnIndex, height) * rowIndex;
var calculateVerticalPositioning = ({ rowIndex, columnIndex, rowHeight: height }) => {
  return calculateHeightIncrease(columnIndex, rowIndex, height) + calculateVerticalStartingPoint(columnIndex, height);
};
var calculatePositionOfMatch = (rowIndex, columnIndex, { canvasPadding, rowHeight, columnWidth, offsetX = 0, offsetY = 0 }) => {
...
var useMatchHighlightContext = ({ bracketSnippet = null }) => {
  var _a, _b, _c, _d;
...
var use_match_highlight_default = useMatchHighlightContext;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/components/connector.js
var Connector = ({ bracketSnippet, previousBottomMatchPosition = null, previousTopMatchPosition = null, currentMatchPosition, style }) => {
...
// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-single/connectors.js
var Connectors = ({ bracketSnippet, rowIndex, columnIndex, style, offsetY = 0 }) => {
...
var themes_default = defaultTheme;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-single/single-elim-bracket.js
var SingleEliminationBracket = ({ matches, matchComponent, currentRound, onMatchClick, onPartyClick, svgWrapper: SvgWrapper = ({ children }) => (0, import_jsx_runtime6.jsx)("div", { children }), theme = themes_default, options: { style: inputStyle } = {
  style: defaultStyle
} }) => {
  var _a, _b;
...
var single_elim_bracket_default = SingleEliminationBracket;
...
var calculateVerticalStartingPoint2 = (columnIndex, height) => 2 ** columnIndex * (height / 2) - height / 2;
var columnIncrement2 = (columnIndex, height) => 2 ** columnIndex * height;
var calculateHeightIncrease2 = (columnIndex, rowIndex, height) => columnIncrement2(columnIndex, height) * rowIndex;
var calculateVerticalPositioning2 = ({ rowIndex, columnIndex, rowHeight: height }) => {
  return calculateHeightIncrease2(columnIndex, rowIndex, height) + calculateVerticalStartingPoint2(columnIndex, height);
};
var calculatePositionOfFinalGame = (rowIndex, columnIndex, { canvasPadding, rowHeight, columnWidth, gameHeight, upperBracketHeight, lowerBracketHeight, offsetX = 0, offsetY = 0 }) => {
...
var calculatePositionOfMatchUpperBracket = (rowIndex, columnIndex, { canvasPadding, rowHeight, columnWidth, offsetX = 0, offsetY = 0 }) => {
  const yResult = calculateVerticalPositioning2({
    rowHeight,
    rowIndex,
    columnIndex
  });
  const skipStep = (index2) => Math.floor((index2 + 1) * 2) - 3;
...
var returnLowerBracketColumnIndex = (columnIndex) => Math.ceil((columnIndex + 1) / 2) - 1;
var calculatePositionOfMatchLowerBracket = (rowIndex, columnIndex, { canvasPadding, rowHeight, columnWidth, offsetX = 0, offsetY = 0 }) => {
  const result = calculateVerticalPositioning2({
    rowHeight,
    rowIndex,
...
var ConnectorsUpper = ({ bracketSnippet, rowIndex, columnIndex, style, offsetY = 0, isLowerBracket = false }) => {
  const { columnWidth, rowHeight, canvasPadding } = getCalculatedStyles(style);
  ...
  return (0, import_jsx_runtime7.jsx)(connector_default, { bracketSnippet, previousBottomMatchPosition, previousTopMatchPosition, currentMatchPosition, style });
};
var upper_connectors_default = ConnectorsUpper;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-double/upper-bracket.js
var UpperBracket = ({ columns, calculatedStyles, gameHeight, gameWidth, onMatchClick, onPartyClick, matchComponent }) => {
  ...
  return columns.map((matchesColumn, columnIndex) => matchesColumn.map((match, rowIndex) => {
    ...
    const previousBottomPosition = (rowIndex + 1) * 2 - 1;
    const { previousTopMatch, previousBottomMatch } = getPreviousMatches(columnIndex, columns, previousBottomPosition);
    return (0, import_jsx_runtime8.jsxs)("g", { children: [columnIndex !== 0 && (0, import_jsx_runtime8.jsx)(upper_connectors_default, Object.assign({}, {
      bracketSnippet: {
        currentMatch: match,
        previousTopMatch,
        previousBottomMatch
    ...
    })), (0, import_jsx_runtime8.jsx)("g", { children: (0, import_jsx_runtime8.jsx)(match_wrapper_default, { x, y: y + (roundHeader.isShown ? roundHeader.height + roundHeader.marginBottom : 0), rowIndex, columnIndex, match, previousBottomMatch, topText: match.startTime, bottomText: match.name, teams: match.participants, onMatchClick, onPartyClick, style: calculatedStyles, matchComponent }) })] }, x + y);
  }));
};
var upper_bracket_default = UpperBracket;
...
var ConnectorsLower = ({ bracketSnippet, rowIndex, columnIndex, style, offsetY = 0 }) => {
  const { columnWidth, rowHeight, canvasPadding } = getCalculatedStyles(style);
  ...
  const previousBottomPosition = isUpperSeedingRound ? rowIndex : (rowIndex + 1) * 2 - 1;
  const previousTopMatchPosition = !isUpperSeedingRound && calculatePositionOfMatchLowerBracket(previousBottomPosition - 1, columnIndex - 1, {
    canvasPadding,
    rowHeight,
    columnWidth,
    offsetY
  ...
  return (0, import_jsx_runtime9.jsx)(connector_default, { bracketSnippet, previousBottomMatchPosition, previousTopMatchPosition, currentMatchPosition, style });
};
var lower_connectors_default = ConnectorsLower;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-double/lower-bracket.js
var LowerBracket = ({ columns, calculatedStyles, gameHeight, gameWidth, onMatchClick, onPartyClick, matchComponent, upperBracketHeight }) => {
  const { canvasPadding, columnWidth, rowHeight, roundHeader } = calculatedStyles;
  return columns.map((matchesColumn, columnIndex) => matchesColumn.map((match, rowIndex) => {
    ...
    const previousBottomPosition = isUpperSeedingRound ? rowIndex : (rowIndex + 1) * 2 - 1;
    const { previousTopMatch, previousBottomMatch } = getPreviousMatches(columnIndex, columns, previousBottomPosition);
    return (0, import_jsx_runtime10.jsxs)("g", { children: [columnIndex !== 0 && (0, import_jsx_runtime10.jsx)(lower_connectors_default, Object.assign({}, {
      bracketSnippet: {
        currentMatch: match,
      ...
      style: calculatedStyles,
      offsetY: upperBracketHeight
    })), (0, import_jsx_runtime10.jsx)("g", { children: (0, import_jsx_runtime10.jsx)(match_wrapper_default, { x, y: y + (roundHeader.isShown ? roundHeader.height + roundHeader.marginBottom : 0), rowIndex, columnIndex, match, previousBottomMatch, topText: match.startTime, bottomText: match.name, teams: match.participants, onMatchClick, onPartyClick, style: calculatedStyles, matchComponent }) })] }, x + y);
  }));
};
var lower_bracket_default = LowerBracket;
...
function RoundHeaders({ numOfRounds, calculatedStyles: { canvasPadding, columnWidth, rowHeight, roundHeader, width } }) {
  return (0, import_jsx_runtime11.jsx)(import_jsx_runtime11.Fragment, { children: [...new Array(numOfRounds)].map((matchesColumn, columnIndex) => {
    const { x } = calculatePositionOfMatchLowerBracket(0, columnIndex, {
      canvasPadding,
      columnWidth,
      rowHeight
    });
    return (0, import_jsx_runtime11.jsx)("g", { children: roundHeader.isShown && (0, import_jsx_runtime11.jsx)(RoundHeader, { x, roundHeader, canvasPadding, width, numOfRounds, tournamentRoundText: (columnIndex + 1).toString(), columnIndex }) }, `round ${x}`);
  }) });
}
var round_headers_default = RoundHeaders;
...
var FinalConnectors = ({ rowIndex, columnIndex, style, bracketSnippet = null, offsetY = 0, numOfUpperRounds, numOfLowerRounds, lowerBracketHeight, upperBracketHeight, gameHeight }) => {
  const { columnWidth, rowHeight, canvasPadding } = getCalculatedStyles(style);
  ...
  return (0, import_jsx_runtime12.jsx)(connector_default, { bracketSnippet, previousBottomMatchPosition, previousTopMatchPosition, currentMatchPosition, style });
};
var final_connectors_default = FinalConnectors;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-double/final-game.js
var FinalGame = ({ match, rowIndex, columnIndex, gameHeight, gameWidth, calculatedStyles, onMatchClick, onPartyClick, matchComponent, bracketSnippet, numOfUpperRounds, numOfLowerRounds, upperBracketHeight, lowerBracketHeight }) => {
  const { canvasPadding, columnWidth, rowHeight, roundHeader } = calculatedStyles;
  ...
  return (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [columnIndex !== 0 && (0, import_jsx_runtime13.jsx)(final_connectors_default, Object.assign({}, {
    numOfUpperRounds,
    numOfLowerRounds,
    rowIndex,
    columnIndex,
    ...
    style: calculatedStyles,
    bracketSnippet
  })), (0, import_jsx_runtime13.jsx)("g", { children: (0, import_jsx_runtime13.jsx)(match_wrapper_default, { x, y: y + (roundHeader.isShown ? roundHeader.height + roundHeader.marginBottom : 0), rowIndex, columnIndex, match, previousBottomMatch: bracketSnippet.previousBottomMatch, topText: match.startTime, bottomText: match.name, teams: match.participants, onMatchClick, onPartyClick, style: calculatedStyles, matchComponent }) })] });
};
var final_game_default = FinalGame;
...
var FinalConnectors2 = ({ rowIndex, columnIndex, style, bracketSnippet = null, offsetY = 0, numOfLowerRounds, lowerBracketHeight, upperBracketHeight, gameHeight }) => {
  const { columnWidth, rowHeight, canvasPadding } = getCalculatedStyles(style);
  const currentMatchPosition = calculatePositionOfFinalGame(rowIndex, columnIndex, {
    canvasPadding,
    rowHeight,
  ...
  return (0, import_jsx_runtime14.jsx)(connector_default, { bracketSnippet, previousBottomMatchPosition, currentMatchPosition, style });
};
var extra_final_connectors_default = FinalConnectors2;

// node_modules/@g-loot/react-tournament-brackets/dist/esm/bracket-double/extra-final.js
var ExtraFinal = ({ match, rowIndex, columnIndex, gameHeight, gameWidth, calculatedStyles, onMatchClick, onPartyClick, matchComponent, bracketSnippet, numOfUpperRounds, numOfLowerRounds, upperBracketHeight, lowerBracketHeight }) => {
  const { canvasPadding, columnWidth, rowHeight, roundHeader } = calculatedStyles;
  const { x, y } = calculatePositionOfFinalGame(rowIndex, columnIndex, {
    canvasPadding,
    columnWidth,
  ...
  return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [columnIndex !== 0 && (0, import_jsx_runtime15.jsx)(extra_final_connectors_default, Object.assign({}, {
    numOfUpperRounds,
    numOfLowerRounds,
    rowIndex,
    columnIndex,
    ...
    style: calculatedStyles,
    bracketSnippet
  })), (0, import_jsx_runtime15.jsx)("g", { children: (0, import_jsx_runtime15.jsx)(match_wrapper_default, { x, y: y + (roundHeader.isShown ? roundHeader.height + roundHeader.marginBottom : 0), rowIndex, columnIndex, match, previousBottomMatch: bracketSnippet.previousBottomMatch, topText: match.startTime, bottomText: match.name, teams: match.participants, onMatchClick, onPartyClick, style: calculatedStyles, matchComponent }) })] });
};
var extra_final_default = ExtraFinal;
...
var DoubleEliminationBracket = ({ matches, matchComponent, currentRound, onMatchClick, onPartyClick, svgWrapper: SvgWrapper = ({ children }) => (0, import_jsx_runtime16.jsx)("div", { children }), theme = themes_default, options: { style: inputStyle } = {
  style: defaultStyle
} }) => {
  ...
  return (0, import_jsx_runtime16.jsx)(ThemeProvider, Object.assign({ theme }, { children: (0, import_jsx_runtime16.jsx)(SvgWrapper, Object.assign({ bracketWidth: gameWidth, bracketHeight: gameHeight, startAt: startPosition }, { children: (0, import_jsx_runtime16.jsx)("svg", Object.assign({ height: gameHeight, width: gameWidth, viewBox: `0 0 ${gameWidth} ${gameHeight}` }, { children: (0, import_jsx_runtime16.jsx)(MatchContextProvider, { children: (0, import_jsx_runtime16.jsxs)("g", { children: [(0, import_jsx_runtime16.jsx)(round_headers_default, Object.assign({}, {
    numOfRounds: totalNumOfRounds,
    calculatedStyles
  })), (0, import_jsx_runtime16.jsx)(upper_bracket_default, Object.assign({}, {
    ...
    onPartyClick,
    matchComponent
  })), (0, import_jsx_runtime16.jsx)(lower_bracket_default, Object.assign({}, {
  ...
  })), (0, import_jsx_runtime16.jsx)(final_game_default, Object.assign({}, {
    ...
    onMatchClick,
    onPartyClick
  })), (finalsArray === null || finalsArray === void 0 ? void 0 : finalsArray.length) > 1 && (0, import_jsx_runtime16.jsx)(extra_final_default, Object.assign({}, {
    match: finalsArray[1],
    numOfUpperRounds: upperColumns.length,
    numOfLowerRounds: lowerColumns.length,
    bracketSnippet: {
...
var double_elim_bracket_default = DoubleEliminationBracket;
...
var Wrapper = styled_components_browser_esm_default.div`
  ...
  font-family: ${({ theme }) => theme.fontFamily};
`;
var TopText = styled_components_browser_esm_default.p`
  color: ${({ theme }) => theme.textColor.dark};
  margin-bottom: 0.2rem;
  min-height: 1.25rem;
`;
var BottomText = styled_components_browser_esm_default.p`
  color: ${({ theme }) => theme.textColor.dark};
  ...
  min-height: 1.25rem;
`;
var StyledMatch = styled_components_browser_esm_default.div`
  display: flex;
  flex-direction: column;
  flex: 1 1 auto;
  justify-content: space-between;
`;
var Team = styled_components_browser_esm_default.div``;
var Score = styled_components_browser_esm_default.div`
  display: flex;
  height: 100%;
  padding: 0 1rem;
  align-items: center;
...
`;
var Side = styled_components_browser_esm_default.div`
  display: flex;
  height: 100%;
  align-items: center;
  justify-content: space-between;
  ...
  ${({ hovered, theme, won }) => hovered && css`
    ...
    `}
`;
var Line = styled_components_browser_esm_default.div`
  height: 1px;
...
`;
var Anchor = styled_components_browser_esm_default.a`
...
// node_modules/@g-loot/react-tournament-brackets/dist/esm/components/match/index.js
function Match2({ bottomHovered, bottomParty, bottomText, bottomWon, match, onMatchClick, onMouseEnter, onMouseLeave, onPartyClick, topHovered, topParty, topText, topWon }) {
  return (0, import_jsx_runtime17.jsxs)(Wrapper, { children: [(0, import_jsx_runtime17.jsxs)("div", Object.assign({ style: { display: "flex", justifyContent: "space-between" } }, { children: [(0, import_jsx_runtime17.jsx)(TopText, { children: topText }), (match.href || typeof onMatchClick === "function") && (0, import_jsx_runtime17.jsx)(Anchor, Object.assign({ href: match.href, onClick: (event) => onMatchClick === null || onMatchClick === void 0 ? void 0 : onMatchClick({ match, topWon, bottomWon, event }) }, { children: (0, import_jsx_runtime17.jsx)(TopText, { children: "Match Details" }) }))] })), (0, import_jsx_runtime17.jsxs)(StyledMatch, { children: [(0, import_jsx_runtime17.jsxs)(Side, Object.assign({ onMouseEnter: () => onMouseEnter(topParty.id), onMouseLeave, won: topWon, hovered: topHovered, onClick: () => onPartyClick === null || onPartyClick === void 0 ? void 0 : onPartyClick(topParty, topWon) }, { children: [(0, import_jsx_runtime17.jsx)(Team, { children: topParty === null || topParty === void 0 ? void 0 : topParty.name }), (0, import_jsx_runtime17.jsx)(Score, Object.assign({ won: topWon }, { children: topParty === null || topParty === void 0 ? void 0 : topParty.resultText }))] })), (0, import_jsx_runtime17.jsx)(Line, { highlighted: topHovered || bottomHovered }), (0, import_jsx_runtime17.jsxs)(Side, Object.assign({ onMouseEnter: () => onMouseEnter(bottomParty.id), onMouseLeave, won: bottomWon, hovered: bottomHovered, onClick: () => onPartyClick === null || onPartyClick === void 0 ? void 0 : onPartyClick(bottomParty, bottomWon) }, { children: [(0, import_jsx_runtime17.jsx)(Team, { children: bottomParty === null || bottomParty === void 0 ? void 0 : bottomParty.name }), (0, import_jsx_runtime17.jsx)(Score, Object.assign({ won: bottomWon }, { children: bottomParty === null || bottomParty === void 0 ? void 0 : bottomParty.resultText }))] }))] }), (0, import_jsx_runtime17.jsx)(BottomText, { children: bottomText !== null && bottomText !== void 0 ? bottomText : " " })] });
}
...
function RandomUID(WrappedComponent) {
  class RandomUID2 extends import_react5.default.Component {
    ...
    render() {
      return import_react5.default.createElement(WrappedComponent, _extends2({
        _uid: this.state.uid
      }, this.props));
    }
  }
...
function BorderGradient(_ref) {
  ...
  return import_react6.default.createElement("g", null, import_react6.default.createElement("defs", null, import_react6.default.createElement("linearGradient", {
    id: gradientID,
    x1: "0%",
    y1: "0%",
    x2: "100%",
    y2: "0%",
    spreadMethod: "pad"
  }, import_react6.default.createElement("stop", {
    offset: "0%",
    stopColor: "#fff",
    stopOpacity: "0.8"
  }), import_react6.default.createElement("stop", {
    ...
    stopColor: "#000",
    stopOpacity: "0.5"
  })), import_react6.default.createElement("mask", {
    id: maskID,
    x: "0",
    y: "0",
    width: "20",
...
function Selection(_ref) {
  ...
  return import_react7.default.createElement("rect", {
    stroke: "#969FFF",
    strokeOpacity: 0.7,
    fill: "#F3F4FF",
    fillOpacity: 0.7,
...
function IconZoomIn() {
  return import_react10.default.createElement("svg", {
    ...
    height: 24,
    stroke: "currentColor"
  }, import_react10.default.createElement("g", null, import_react10.default.createElement("path", {
...
var ToolbarButton = class extends import_react13.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      hover: false
...
function Toolbar(_ref) {
  ...
  return import_react14.default.createElement("div", {
    style,
    role: "toolbar"
  }, import_react14.default.createElement(ToolbarButton, {
  ...
  }, import_react14.default.createElement(IconCursor, null)), import_react14.default.createElement(ToolbarButton, {
    toolbarPosition: position,
  ...
  }, import_react14.default.createElement(IconPan, null)), import_react14.default.createElement(ToolbarButton, {
    toolbarPosition: position,
  ...
  }, import_react14.default.createElement(IconZoomIn, null)), import_react14.default.createElement(ToolbarButton, {
    toolbarPosition: position,
  ...
  }, import_react14.default.createElement(IconZoomOut, null)), import_react14.default.createElement(ToolbarButton, {
    toolbarPosition: position,
    active: false,
    activeColor: activeToolColor,
    name: "fit-to-viewer",
  ...
  }, import_react14.default.createElement(IconFit, null)));
}
Toolbar.propTypes = {
...
function MiniatureToggleButton(_ref) {
  ...
  }, import_react16.default.createElement(IconArrow, {
...
function MiniatureMask(_ref) {
  ...
  return import_react17.default.createElement("g", null, import_react17.default.createElement("defs", null, import_react17.default.createElement("mask", {
    id: maskID
  }, import_react17.default.createElement("rect", {
    x: SVGMinX,
    y: SVGMinY,
    width: SVGWidth,
    height: SVGHeight,
...
function Miniature(_ref) {
  ...
  return import_react18.default.createElement("div", {
  ...
  }, import_react18.default.createElement("g", {
    ...
    width: SVGWidth,
    height: SVGHeight
  }), children, import_react18.default.createElement(miniature_mask_default, {
    SVGWidth,
    SVGHeight,
    SVGMinX,
    SVGMinY,
    ...
    y2,
    zoomToFit
  })))), import_react18.default.createElement(MiniatureToggleButton, {
    value,
    onChangeValue,
    position
  }));
...
var ReactSVGPanZoom = class extends import_react19.default.Component {
  ...
  render() {
    ...
    }), import_react19.default.createElement("g", {
    ...
    }), import_react19.default.createElement("g", null, props.children.props.children)), !([TOOL_NONE, TOOL_AUTO].indexOf(tool) >= 0 && props.detectAutoPan && value.focus) ? null : import_react19.default.createElement("g", {
      style: {
        pointerEvents: "none"
      }
    }, !(pointerY <= 20) ? null : import_react19.default.createElement(border_gradient_default, {
      direction: POSITION_TOP,
      width: value.viewerWidth,
      height: value.viewerHeight
    }), !(value.viewerWidth - pointerX <= 20) ? null : import_react19.default.createElement(border_gradient_default, {
      direction: POSITION_RIGHT,
      width: value.viewerWidth,
      height: value.viewerHeight
    }), !(value.viewerHeight - pointerY <= 20) ? null : import_react19.default.createElement(border_gradient_default, {
      direction: POSITION_BOTTOM,
      width: value.viewerWidth,
      height: value.viewerHeight
    }), !(value.focus && pointerX <= 20) ? null : import_react19.default.createElement(border_gradient_default, {
      direction: POSITION_LEFT,
      width: value.viewerWidth,
      height: value.viewerHeight
    })), !(value.mode === MODE_ZOOMING) ? null : import_react19.default.createElement(Selection, {
      startX: value.startX,
      startY: value.startY,
      endX: value.endX,
      endY: value.endY
    })), props.toolbarProps.position === POSITION_NONE ? null : import_react19.default.createElement(CustomToolbar, _extends3({}, this.props.toolbarProps, {
      value,
      onChangeValue: (value2) => this.setValue(value2),
      tool,
      onChangeTool: (tool2) => this.props.onChangeTool(tool2)
    })), props.miniatureProps.position === POSITION_NONE ? null : import_react19.default.createElement(CustomMiniature, _extends3({}, this.props.miniatureProps, {
      value,
      onChangeValue: (value2) => this.setValue(value2),
...
var UncontrolledReactSVGPanZoom = class extends import_react20.default.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return import_react20.default.createElement(ReactSVGPanZoom, _extends4({
      width,
      height,
      tool,
...
var precisionRound = (number, precision) => {
...
var SvgViewer = (_a) => {
  var { height = 500, width = 500, bracketWidth, bracketHeight, children, startAt = [0, 0], scaleFactor = 1.1, customToolbar = null } = _a, rest = __rest2(_a, ["height", "width", "bracketWidth", "bracketHeight", "children", "startAt", "scaleFactor", "customToolbar"]);
  const Viewer = (0, import_react21.useRef)(null);
  const [tool, setTool] = (0, import_react21.useState)(TOOL_AUTO);
  const [value, setValue] = (0, import_react21.useState)(INITIAL_VALUE);
  const [scaleFactorMin, setScaleFactorMin] = (0, import_react21.useState)(1);
  ...
  return (0, import_jsx_runtime18.jsx)(ReactSVGPanZoom, Object.assign({ detectAutoPan: false, ref: Viewer, scaleFactor, scaleFactorMax, scaleFactorMin, width: Math.min(width, bracketWidth), height: Math.min(height, bracketHeight), tool, onChangeTool: setTool, value, onChangeValue: setValue, onZoom: lockToBoundaries, onPan: lockToBoundaries, miniatureProps: { position: "right" }, customToolbar: customToolbar !== null && customToolbar !== void 0 ? customToolbar : (() => (0, import_jsx_runtime18.jsx)(import_jsx_runtime18.Fragment, {})) }, rest, { children }));
};
var svg_viewer_default = SvgViewer;
export {
  double_elim_bracket_default as DoubleEliminationBracket,
  MATCH_STATES,
  match_default as Match,
  svg_viewer_default as SVGViewer,
  single_elim_bracket_default as SingleEliminationBracket,
  createTheme
};
...
merge-anything/dist/index.esm.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=@g-loot_react-tournament-brackets.js.map
